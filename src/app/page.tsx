    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 overflow-hidden">
      ...
      >
        ...
        <motion.div className="mb-16 text-center" variants={itemVariants}>
          <motion.h1
            className="text-6xl sm:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400"
        ...
        >
          ...
          <motion.div className="lg:col-span-1" variants={itemVariants}>
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6 shadow-2xl hover:shadow-cyan-500/20 transition-shadow duration-300">
          ...
          <motion.div className="lg:col-span-1" variants={itemVariants}>
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6 shadow-2xl hover:shadow-purple-500/20 transition-shadow duration-300 h-full">
          ...
          {/* Leaderboard - Right */}
          <motion.div className="lg:col-span-1" variants={itemVariants}>
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6 shadow-2xl hover:shadow-pink-500/20 transition-shadow duration-300 h-full">
        ...
        <motion.div className="mt-12" variants={itemVariants}>
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-8 shadow-2xl hover:shadow-blue-500/20 transition-shadow duration-300">
        ...
        {/* Footer */}
        <motion.div className="mt-16 pt-8 border-t border-slate-700/50 text-center text-slate-400" variants={itemVariants}>
